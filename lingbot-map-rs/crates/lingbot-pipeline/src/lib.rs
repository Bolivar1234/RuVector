...
use lingbot_model::{Frame, KeyframeFeatures, PointCloud, Reconstructor};
...
pub enum PipelineError {
    /// Memory layer error.
    #[error("memory: {0}")]
    Memory(#[from] lingbot_memory::MemoryError),
    /// I/O / encoding error.
    #[error("io: {0}")]
    Io(#[from] lingbot_io::IoError),
}
