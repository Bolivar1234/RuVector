//! `lingbot` — native demo CLI for the LingBot-Map Rust port.
//!
...
//!
//! ```text
//! lingbot render --frames 60 --width 640 --height 480 --out out.mp4 \
//!                --png-dir frames --fps 20 --top-k 16
//! lingbot inspect --weights model.safetensors
//! ```

use anyhow::{Context, Result};
use clap::{Parser, Subcommand};
use lingbot_io::{mp4enc::Mp4Sink, save_png, FrameSink, MultiSink, PngSequenceSink};
use lingbot_model::{ModelConfig, SyntheticReconstructor};
use lingbot_pipeline::{scene, SoftwareRenderer, StreamingReconstructor};
use lingbot_tensor::WeightIndex;
...
struct RenderArgs {
    ...
    height: usize,
    /// Output MP4 path.
    #[arg(long, default_value = "lingbot_out.mp4")]
    out: PathBuf,
